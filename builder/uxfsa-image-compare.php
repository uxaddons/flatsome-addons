<?php
add_ux_builder_shortcode( 'uxfsa_addons_image_compare', array(
    'type' => 'container',
    ...
    'thumbnail' => UXFSA_Flatsome_Addons_URL.'thumbnails/uxfsa_addons_image_compare.jpg',
    'wrap'   => false,
    'info' => '{{ label }}',
    'priority' => -1,
...
add_ux_builder_shortcode( 'ux_image', array(
    ...
    'thumbnail' =>  UXFSA_Flatsome_Addons_URL.'builder/thumbnails/uxfsa_image.jpg',
    'wrap' => false,
